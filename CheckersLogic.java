...
public class CheckersLogic implements ActionListener
{
    ...
    private boolean isPastTimeLimit;
    ...
    public void run()
    {
        ...
        while(numRedTiles>0 && numWhiteTiles>0 && !isPastTimeLimit)
        {
            System.out.print("");
        ...
        if (!isPastTimeLimit && redTurn)
        {
            reconfigureLabelPanel("RED WINS!");
            timerLabel.setText("<html><b>It took " + timerLabel.getText().substring(9,14) + " minutes!<html><b>");
        }
        else if (!isPastTimeLimit && !redTurn)
        {
        ...
        {
            reconfigureLabelPanel("IT'S A TIE!");
            timerLabel.setText("<html><b>You are past the 45 minute time limit!<html><b>");
        }
    }
    ...
    Thread timer = new Thread()
    {
        public void run()
        {
            ...
            { 
                ...
                {
                    timer.sleep(1000);
                    timerLabel.setText("<html><b>" + (seconds/600) + ((seconds/60)%10) + ":" + 
                                        ((seconds%60)/10) + ((seconds%60)%10) + " minutes have passed...</b></html>");
                    seconds++;
                }
    ...
    public void reconfigureLabelPanel(String text)
    {
        ...
        {
            label.setText("<html><div style='text-align:center;'><b>" + text + "</b></div></html>");
        }
    }
